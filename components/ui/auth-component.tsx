...
export const AuthComponent = ({
  ...
  const handleFinalSubmit = async (e: React.FormEvent) => {
    ...
    // For signup, must be on confirmPassword step; for signin, must be on password step
    if (mode === "signup" && authStep !== "confirmPassword") return;
    if (mode === "signin" && authStep !== "password") return;
  ...
  const handleProgressStep = () => {
    if (authStep === "email") {
      ...
      if (mode === "signin" && isPasswordValid) {
        // For sign-in, submit after password
      ...
      >
        ...
        >
          ...
          <form onSubmit={handleFinalSubmit} className="w-[300px] space-y-6">
            <AnimatePresence>
              {(mode === "signin" || authStep !== "confirmPassword") && (
                <motion.div
                    ...
                    <div className="relative w-full">
                      ...
                      <div className="glass-input-wrap w-full">
                        <div className="glass-input">
                          ...
                          <div
                            className={cn(
                              "relative z-10 shrink-0 flex items-center justify-center overflow-hidden transition-all duration-300 ease-in-out",
                              email.length > 20 && authStep === "email"
                                ? "w-0 px-0"
                                : "w-10 pl-2"
                            )}
                          >
                            <Mail className="h-5 w-5 text-foreground/80 shrink-0" />
                          </div>
                          <input
                            type="email"
                            placeholder="Email"
                            ...
                            className={cn(
                              "relative z-10 h-full w-0 grow bg-transparent text-foreground placeholder:text-foreground/60 focus:outline-none transition-[padding-right] duration-300 ease-in-out delay-300",
                            ...
                            <div className="glass-input">
                              ...
                              <div className="relative z-10 shrink-0 flex items-center justify-center w-10 pl-2">
                                {isPasswordValid ? (
                                  ...
                                  <Lock className="h-5 w-5 text-foreground/80 shrink-0" />
                                )}
                              </div>
                              <input
                                ...
                                onKeyDown={handleKeyDown}
                                className="relative z-10 h-full w-0 grow bg-transparent text-foreground placeholder:text-foreground/60 focus:outline-none"
                              />
                              <div
                                className={cn(
                                  "relative z-10 shrink-0 overflow-hidden transition-all duration-300 ease-in-out",
            ...
            <AnimatePresence>
              {mode === "signup" && authStep === "confirmPassword" && (
